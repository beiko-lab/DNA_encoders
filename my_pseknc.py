...
class Pseknc():
    ...
    def __init__(self,L=58):
        ...
        self.original_supInfo = {"Bendability-DNAse":[5.7,6.2,8.2,5.2,6.6,5.1,5.6,3.6,4.3,7.5,8.2,6.3,6.8,6.4,5.6,1.6,4.7,6.5,6.3,2,4.2,0.1,\
        ...
        self.supInfo = {'Bendability-DNAse': [0.07230364, 0.26511335, 1.0363522, -0.12050607, 0.41936112,
